...
#define SDRAM_RADDR ((paddr_t)0xa0000000)
#define SDRAM_SIZE 0x20000000

#define PSRAM_RADDR ((paddr_t)0x80000000)
#define PSRAM_SIZE 0x30000000
...
static inline bool in_sram(paddr_t addr) {
  return addr - SRAM_RADDR < SRAM_SIZE;
}

static inline bool in_sdram(paddr_t addr) {
  return addr - SDRAM_RADDR < SDRAM_SIZE;
}

static inline bool in_psram(paddr_t addr) {
  return addr - PSRAM_RADDR < PSRAM_SIZE;
}
